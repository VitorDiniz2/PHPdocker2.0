...
<html lang="PT-BR">
  <head>
    ...
    <title>Sobre Nós-Eduverde</title>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <li><a href="index.php" class="nav-link px-2 text-dark">Home</a></li>
          <li><a href="textos.php" class="nav-link px-2 text-white">Textos</a></li>
        ...
        <?php
          if ( isset($_SESSION['user']["id"]) ){
            echo "<a class='nav-link px-2 text-white' href='../logout.php'>Logout</a>";
          }else{
  ...
  <section class="py-5">
                <div class="container px-5 my-5">
                    <div class="text-center mb-5">
                        <h1 class="fw-bolder">Peguntas Frequentes</h1>
                        <p class="lead fw-normal text-muted mb-0">Como funciona o EduVerde?</p>
                    </div>
                    <div class="row gx-5">
                        <div class="col-xl-8">
                            <!-- FAQ Accordion 1-->
                                ...
                                <div class="card-body p-4 py-lg-5">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <div class="text-center">
                                            <div class="h6 fw-bolder">Mais alguma dúvida?</div>
                                            <p class="text-muted mb-4">
                                                Entre em contato conosco e-mail
                                                <br />
                                                <a href="#!">support@eduverde.com</a>
                                            </p>
...
<section class="py-5 bg-light">
                <div class="container px-5 my-5">
                    <div class="text-center">
                        ...
                        <p class="lead fw-normal text-muted mb-5">Equipe Eduverde</p>
                    </div>
